...
public class EmployeeDAO {
	 ...
	 * @throws  
	 */
	public List<Employee> syainSearch() throws ClassNotFoundException, SQLException, IOException, IllegalInputException  {
		...
		try {
			...
			if(enReader.isValid(searchWord)){
				throw new IllegalInputException(ConstantMsg.SYAIN_NAME_LENGTH_ERROR);
			}
